...
$branch = substr($sub_code,0,2);
$branch = $branch."_feedback";
$sql1 = "SELECT COLUMN_COMMENT FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'trial' AND TABLE_NAME = 'sub_feedback' AND COLUMN_COMMENT!=''";
...
<form action="" method="post" id="feed_form">
      <div class="row">
        <div class="input-field col s6">
          <input disabled name="sub_code" value="<?php echo $sub_code;?>" id="disabled" type="text"  class="validate">
      ...
      <div class="row">
        <div class="input-field col s6">
          ...
          <label for="disabled">Instructor Name</label>
        </div>
      </div>
        <?php
          while($row1 = $res1->fetch_row())
          {
            ...
            <?php else:?>
              <div class="col s1">
              <label>
                <input class="with-gap" name="<?php echo $row2[0];?>" value="1" type="radio" checked/>
                <span>1</span>
              </label>
            </div>
            <?php endif;?>
          ...
          <div class="col s1">
           ...
           <div class="col s1">
            ...
            <?php else:?>
              <div class="col s1">
              <label>
                <input class="with-gap" name="<?php echo $row2[0];?>" value="Yes" type="radio" checked/>
                <span>Yes</span>
              </label>
         </div>
            <?php endif;?>
           ...
           <div class="row">
            ...
            <div class="col s2">
              <label>
                <input class="with-gap" name="<?php echo $row2[0];?>" value="Slow" type="radio" checked required=""/>
                <span>Slow</span>
              </label>
            </div>
            <?php else:?>
              <div class="col s2">
              <label>
                <input class="with-gap" name="<?php echo $row2[0];?>" value="Slow" type="radio" checked/>
                <span>Slow</span>
              </label>
            </div>
            <?php endif;?>
            <div class="col s2">
              <label>
                <input class="with-gap" name="<?php echo $row2[0];?>" value="Medium" type="radio" />
                <span>Medium</span>
              </label>
            </div>
            <div class="col s2">
              <label>
                <input class="with-gap" name="<?php echo $row2[0];?>" value="Fast" type="radio" />
                <span>Fast</span>
              </label>
              </div>
            </div>
           <?php
            ...
            ?>
             <div class="input-field col s12">
              <textarea id="add" name="<?php echo $row2[0];?>" class="materialize-textarea"></textarea>
