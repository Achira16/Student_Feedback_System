$(document).ready(function(){
    ...
    $.ajax({
        type:"POST",
        url:"/stud_feed_sys/profiles/rev_profiles/new.php",
        data:"",
        success:function(data){
          if(data != "null")
          {
              ...
              if(obj.position.indexOf('HOD')!=-1){
                  ...
                  $('#li6').html('<a id="feed6" href="http://localhost/stud_feed_sys/profiles/rev_profiles/add_sub_info.php" style="color:white;font-size:large;"><b>Add Subjects</b></a>');
              }
